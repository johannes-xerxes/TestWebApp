        ...
        <div class="row">
            ...
            <div class="col-md-4 d-flex">
                <div class="home-fact-box mr-md-auto ml-auto mr-auto">
                    ...
                    <div class="text-box">
                        ...
                        <p><?php echo get_phrase('Learn_many_topics'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 d-flex">
                <div class="home-fact-box mr-md-auto ml-auto mr-auto">
                    ...
                    <div class="text-box">
                        <h4><?php echo get_phrase('Right_choice_of_Learning'); ?></h4>
                        <p><?php echo get_phrase('find_it'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 d-flex">
                <div class="home-fact-box mr-md-auto ml-auto mr-auto">
                    ...
                    <div class="text-box">
                        <h4><?php echo get_phrase('Access_anywhere'); ?></h4>
                        <p><?php echo get_phrase('ELearning_is_open'); ?></p>
                    </div>
                </div>
            </div>
        </div>
